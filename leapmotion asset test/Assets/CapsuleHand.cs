...
namespace Leap.Unity {
  ...
  public class CapsuleHand : HandModelBase {
    ...
    private static Color[] _rightColorList = { new Color(0.0f, 0.0f, 0.0f) };  //new Color(1.0f, 1.0f, 0.0f), new Color(1.0f, 0.5f, 0.0f) };
    ...
    public void updateHandColor(float r, float g, float b) {
            _sphereMat.color = new Color(r, g, b);
            UpdateHand();
        }
